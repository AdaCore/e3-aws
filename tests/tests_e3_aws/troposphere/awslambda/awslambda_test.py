...
@pytest.mark.parametrize(
    "event_source",
    [
        # Event from an HTTP API
        "http",
        # Event from a REST API
        "rest",
        # Event from an ELB
        "elb",
    ],
)
def test_create_flask_wsgi_environ_with_event(event_source: str) -> None:
    """Test create_flask_wsgi_environ with a lambda event.
